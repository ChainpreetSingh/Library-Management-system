...
namespace Library_System.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,ISBN,PublicationDate,Stock,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,ISBN,PublicationDate,Stock,AuthorId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
        ...
        [HttpGet]
        public async Task<IActionResult> Index(string searchString, string filterBy)
        {
